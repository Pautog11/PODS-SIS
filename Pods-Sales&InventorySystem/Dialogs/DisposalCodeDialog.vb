...
Public Class DisposalCodeDialog
    ...
    Private Sub DisposalCodeDialog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub AddButton_Click(sender As Object, e As EventArgs) Handles AddButton.Click
        Try
            ...
            Dim baseCommand As BaseDisposalCode = Nothing
            ...
            If Not result.Any(Function(item As Object()) Not item(0)) Then
                ...
                baseCommand = New BaseDisposalCode(data)

                If BaseDisposalCode.Exists(result(0)(1)) = 0 AndAlso _data Is Nothing Then
                    invoker = New AddCommand(baseCommand)
                    invoker?.Execute()
                    _subject.NotifyObserver()
                    Me.Close()
                ElseIf _data IsNot Nothing Then
                    If BaseDisposalCode.Exists(result(0)(1)) = 1 Then
                        If BaseDisposalCode.ExistsWithId(_data.Item("id"), result(0)(1)) = 1 Then
