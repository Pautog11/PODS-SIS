...
Public Class BaseCategory
    ...
    Public Shared Function Search(query As String) As pods.tblcategoriesDataTable
        Try
            ...
            Dim dTable As New pods.tblcategoriesDataTable
            Dim adapter As New SqlDataAdapter(cmd)
            adapter.Fill(dTable)
            Return dTable
        Catch ex As Exception
            MessageBox.Show(ex.Message)
            Return New pods.tblcategoriesDataTable
        End Try
    End Function
End Class
