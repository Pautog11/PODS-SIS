...
Public Class FinancialRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pods_Sales_InventorySystem.FinancialRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinancialRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinancialRpt = New FinancialRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
